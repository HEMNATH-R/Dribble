  ...
  <div class="container my-5">
    <div class="row g-4">
      <div class="col-6 col-md-3">
        <div class="card">
          <img src="CHENNAI.jpg" class="card-img-top" alt="Placeholder">
          <div class="card-body">
      ...
      <div class="col-6 col-md-3">
        <div class="card">
          <img src="Kerala.jpg" class="card-img-top" alt="Placeholder">
          <div class="card-body">
      ...
      <div class="col-6 col-md-3">
        <div class="card">
          <img src="FORT.jpg" class="card-img-top" alt="Placeholder">
          <div class="card-body">
      ...
      <div class="col-6 col-md-3">
        <div class="card">
          <img src="Cricket.jpg" class="card-img-top" alt="Placeholder">
          <div class="card-body">
      ...
      <div class="col-6 col-md-3">
        <div class="card">
          <img src="wonderla-amusement-park.webp" class="card-img-top" alt="Placeholder">
          <div class="card-body">
      ...
      <div class="col-6 col-md-3">
        <div class="card">
          <img src="Mahabalipuram Beach.jpeg" class="card-img-top" alt="Placeholder">
          <div class="card-body">
